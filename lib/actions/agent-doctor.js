...
function agentDoctor(target = '.', options = {}) {
  ...
  checkRequiredDirectory(targetDirectory, `${SOURCE_DIRECTORY_NAME}/templates/common-skills`, issues);
  checkRequiredDirectory(targetDirectory, `${SOURCE_DIRECTORY_NAME}/templates/bundled-skills`, issues);
