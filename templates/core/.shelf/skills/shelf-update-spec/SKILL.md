---
name: shelf-update-spec
description: "Captures executable contracts and coding conventions into .shelf/spec/ documents. Use when learning something valuable from debugging, implementing, or discussion that should be preserved for future sessions."
---
...
```bash
cat .shelf/spec/<category>/<file>.md
```
