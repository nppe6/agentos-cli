...
- [ ] Update `.shelf/spec/guides/` thinking guides
- [ ] Update relevant `.shelf/spec/` docs
...
2. **Sync templates** - After updating `.shelf/spec/`, sync to `src/templates/markdown/spec/`
