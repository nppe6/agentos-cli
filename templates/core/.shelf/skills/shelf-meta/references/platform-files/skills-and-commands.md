...
Skills and commands are textual entry points for user interaction with AgentOS Shelf. Different platforms use different names, but their core purpose is the same: tell the AI how to enter the AgentOS Shelf flow when the user expresses a certain intent.
