...
Create `.shelf/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".shelf/spec/mobile/index.md",
...
```jsonl
{"file": ".shelf/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".shelf/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```
