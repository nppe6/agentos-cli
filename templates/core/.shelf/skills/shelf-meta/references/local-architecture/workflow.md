...
`.shelf/workflow.md` has three responsibilities:
...
After editing, make the AI reread `.shelf/workflow.md`; do not assume the flow from the old conversation is still valid.
