...
Detailed guide on AgentOS Shelf feature availability across different AI coding platforms.

---

## Overview

AgentOS Shelf is designed primarily for **Claude Code** but provides partial support for **Cursor**. Future support for **OpenCode** is under consideration.
...
|---------|----------|-------------|
| Workspace system | `.shelf/workspace/` | Journals, session history |
| Task system | `.shelf/tasks/` | Task tracking, requirements |
| Spec system | `.shelf/spec/` | Coding guidelines |
...
| Developer identity | `.shelf/.developer` | Who is working |
| Current task | `.shelf/.runtime/sessions/` | Session-scoped active task state |
...
For teams using Cursor, here's how to get partial AgentOS Shelf benefits:
...
1. Session Start
   ...
   - Read relevant specs from .shelf/spec/
...
| AgentOS Shelf Version | Claude Code | Cursor | OpenCode |
|-----------------|-------------|--------|----------|
...
├── YES → Full AgentOS Shelf support (Claude Code)
