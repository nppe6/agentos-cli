...
description: |
  ...
  Inherits from shelf-meta for base architecture documentation.
  Use this skill to understand what's been customized in this project's AgentOS Shelf setup.
---

# AgentOS Shelf Local - [PROJECT_NAME]

## Overview

This skill documents all customizations made to AgentOS Shelf in this project. For vanilla AgentOS Shelf documentation, see the `shelf-meta` skill.

## Base Information

| Field | Value |
|-------|-------|
| AgentOS Shelf Version | X.X.X |
...
#### spec-name.md
- **Path**: `.shelf/spec/category/spec-name.md`
- **Change**: [what was changed]
- **Date**: YYYY-MM-DD
- **Reason**: [why it was changed]
-->
...
Document any special steps needed when upgrading AgentOS Shelf.

<!-- Template:
### Upgrade to AgentOS Shelf X.Y.Z
...
# AgentOS Shelf Local - PROJECT_NAME_PLACEHOLDER

## Base Information

| Field | Value |
|-------|-------|
| AgentOS Shelf Version | $(cat package.json 2>/dev/null | grep version | head -1 | cut -d'"' -f4 || echo "unknown") |
