...
```jsonl
{"file": ".shelf/spec/cli/frontend/index.md", "reason": "Frontend overview"}
{"file": ".shelf/spec/cli/frontend/component-guidelines.md", "reason": "Component patterns"}
```
...
```
1. Read .shelf/spec/{category}/index.md
...
```bash
touch .shelf/spec/cli/frontend/new-pattern.md
```
...
```bash
mkdir .shelf/spec/mobile
```

### 2. Create Index

```bash
touch .shelf/spec/mobile/index.md
```
