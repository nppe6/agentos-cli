...
Creates:
- `.shelf/.developer` - Identity file
- `.shelf/workspace/<name>/` - Personal workspace
- `.shelf/workspace/<name>/index.md` - Personal index
- `.shelf/workspace/<name>/journal-1.md` - First journal
...
## Active Work
- Current task: `.shelf/tasks/01-31-add-login-taosu`
- Branch: feature/add-login
